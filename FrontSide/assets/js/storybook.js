    ...
    fetch(getAllUrl, {
      ...
      .then((data) => {
        ...
        var allCategoryList = categoryList
          .map((x, i) => {
            return (
              '<div class="bg"><p class="title"><a href="./detail.html" onclick="sendTitle(this)">' +
              categoryList[i] +
              '</a></p><input type="text" class="titleInput" style="display:none;" /><button class="inputeditBtn" style="display:none;">수정하기</button><a href="#" class="menu"><i class="fa-solid fa-ellipsis-vertical" style="color: #000000">...</i><ul class="story-hide" style="display: block"><li id="btnAppend" onclick="add()">추가</li><li class="edit" onclick="changeInput(this)">수정</li><li class="remove" onclick="removeCategory(this)">삭제</li></ul></a></div>'
            );
          })
          .join("");
